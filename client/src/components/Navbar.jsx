        ...
        {!isAuthenticated && (
          <>
            ...
            <li>
              <Link
                to="/extension"
                className="relative px-3 py-2 rounded-lg text-white dark:text-green-400 text-base font-semibold tracking-wide hover:bg-green-200/50 dark:hover:bg-green-900 transition-colors duration-300 hover:shadow-lg flex items-center gap-1"
              >
                🧩 Extension
              </Link>
            </li>
